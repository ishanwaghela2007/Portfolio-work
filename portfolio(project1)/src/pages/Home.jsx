...
import { Mail, Computer } from 'lucide-react'
    ...
    <div className="relative min-h-screen w-full bg-black overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-screen text-center px-4">
        ...
        <div className="opacity-100">
          <h1 className="rounded-lg bg-black/30 backdrop-blur px-8 py-6 text-6xl md:text-7xl font-bold text-white shadow-xl border border-white/25">
            Hi! <span id="wave-emoji" className="inline-block origin-bottom-right">✌️</span>
          </h1>
        </div>

        {/* Bio Section */}
        <div className="mt-8 text-white max-w-2xl backdrop-blur bg-black/20 p-6 rounded-xl border border-white/25 shadow-2xl opacity-100">
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4 opacity-100">
          <Link to="https://resume.tiiny.site" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-8 flex gap-6 opacity-100">
          ...
          <a href="https://github.com/ishanwaghela2007" aria-label="GitHub" className="text-white hover:text-blue-400 transition-all duration-300 transform hover:scale-125">
            <Computer size={24} />
          </a>
        </div>
      </div>
